...
fn main() {
    ...
    let blue_color = Color::Rgb(Rgb::new(0.0, 0.0, 255.0, None));
    // let orange_color = Color::Rgb(Rgb::new(255.0, 165.0, 0.0, None));
    // let pink_color = Color::Rgb(Rgb::new(255.0, 192.0, 203.0, None));
    let purple_color = Color::Rgb(Rgb::new(128.0, 0.0, 128.0, None));
    ...
    println!("rectangle points: {:?}", line1.points);
    ...
    current_layer.set_outline_color(purple_color.clone());
    current_layer.set_outline_thickness(2.0);
